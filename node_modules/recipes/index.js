    ...
    client
      ...
      .on('end', function(result) { done();
        ...
        result.rows.forEach(function(row){
          ...
          if(quantity_containfood_Arr.indexOf(row.quantity_containfood) == -1){
